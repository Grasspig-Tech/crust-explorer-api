...
async function test() {
    ...
    let asd = await api.query.identity.identityOf('5HoubEEVnhHr2ztBA23PwcMci5yHqvVfc2zrc7RLzfQTw79Y')
    let asd2 = await api.query.staking.validators('5HoubEEVnhHr2ztBA23PwcMci5yHqvVfc2zrc7RLzfQTw79Y')
    let tmp: any = await api.query.staking.bonded('5CJ2GyPuBsvJ5xYv7ZmLcH25WXJKGFJPFN2dhFUcMNBo97ss')
