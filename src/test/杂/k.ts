...
async function test() {
    ...
    let oo2 = api.consts.staking.sessionsPerEra;
    ...
    let res = await api.query.market.files('0x7a15ccfb0517f63ccac9976af22d4ef9c8b53a01a065ef5ce055b2b672c680f9');
    console.timeEnd("ces")
    let res2 = await api.query.session.disabledValidators();
    let res33 = await api.query.staking.validatorCount();
    let res44 = await api.query.swork.groups('5FgeE5xLr3f8Q11QeDrDtmr5nvzCrjdrTDDf1R1nsyfdLQVg')
    let res55 = await api.query.swork.groups('5DvTCFuPUXb6Vzg5NB4mFu3Hz95GUqXTMLXib66e4KhF9wxW')
    let res66 = await api.query.technicalMembership.members();
    let res77 = await api.query.technicalMembership.prime();
    let res99 = await api.query.claims.superior();
    console.log(res33)
    debugger;
