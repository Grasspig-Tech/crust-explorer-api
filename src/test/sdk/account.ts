...
async function test() {
  ...
  const io = await api.query.balances.account(accountHash[2]);
  const io22 = await api.query.balances.locks(accountHash[2]);
  const io33 = await api.query.democracy.locks(accountHash[2]);
  ...
  const wqe = await api.queryMulti([
    ...
    [
      ...
      [811, '5DvTCFuPUXb6Vzg5NB4mFu3Hz95GUqXTMLXib66e4KhF9wxW'],
    ],
    [
      api.query.staking.erasStakersClipped,
      [811, '5FBs3aqYmyBREyrW9CDsUKARbwsPPffniPPCDmQonTaMLqb2'],
    ],
    [
      api.query.staking.erasStakersClipped,
      [811, '5GU67fpJTd3iWnmFAXA3TKjwxdMdju54HzrUDB3hLMPyoNtV'],
    ],
    [
      api.query.staking.erasStakersClipped,
      [811, '5GBRJWpphuWF6zQeqnLVHoPkTXYgtNCWngisSF4zMpAxV2pZ'],
    ],
    [
    ...
    [
      api.query.staking.ledger,
      '5FBs3aqYmyBREyrW9CDsUKARbwsPPffniPPCDmQonTaMLqb2',
    ],
    [
      api.query.staking.ledger,
    ...
    [
      api.query.staking.ledger,
      '5GBRJWpphuWF6zQeqnLVHoPkTXYgtNCWngisSF4zMpAxV2pZ',
    ],
  ]);
