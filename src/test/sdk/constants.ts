...
async function test() {
    ...
    let res = api.consts.transactionPayment.transactionByteFee;
    // let res22 = await api.query.market.fileBaseFee.;
    let res22 = await api.query.technicalMembership.members();
    // let res33 = await api.query.timestamp.now.hash();
    let res44 = await api.query.authorship.author.at('0x87eb7270cb12e24e979ff4517596ad951652118c19ee2f5ca2543085c0ddc01b')
    let oo = await api.query.grandpa.state.at('0x87eb7270cb12e24e979ff4517596ad951652118c19ee2f5ca2543085c0ddc01b')
    ...
    let rrr11 = await getControllerAddressByStashAddress([...councilMembers], api);
    let rrr22 = await getControllerAddressByStashAddress([...technicalCommittees], api);
    let rrr33 = await getControllerAddressByStashAddress([...registrars], api);
    // let wqeo = api.query.
    console.log(res22)
    console.log(res)
    debugger;
