...
(() => {
  const all = Array.from(
    document
      .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[1]
      .querySelectorAll('tr > td:nth-of-type(4)')
  );
...
(() => {
  const all = Array.from(
    document
      .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[1]
      .querySelectorAll('tr > td:nth-of-type(6)')
  );
  let total = 0;
  all.forEach(it => {
    let num = it.querySelector('.ui--FormatBalance-value').innerText;
...
(() => {
  const all = Array.from(
    document
      .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[0]
      .querySelectorAll('tr > td:nth-of-type(4)')
  );
  // var all = Array.from(document.querySelectorAll(".Body-sc-1ok469p-0.ejfgQO")[0].querySelectorAll("tr > td:nth-of-type(8)"));
  let total = 0;
...
function getget() {
  ...
  function get1() {
    const all = Array.from(
      document
        .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[0]
        .querySelectorAll('tr > td:nth-of-type(8)')
    );
  ...
  function get2() {
    const all = Array.from(
      document
        .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[0]
        .querySelectorAll('tr > td:nth-of-type(9)')
    );
  ...
  function get3() {
    const all = Array.from(
      document
        .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[0]
        .querySelectorAll('tr > td:nth-of-type(11)')
    );
  ...
  function get4() {
    const all = Array.from(
      document
        .querySelectorAll('.Body-sc-1ok469p-0.ejfgQO')[0]
        .querySelectorAll('tr > td:nth-of-type(12)')
    );
